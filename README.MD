...
Essentially access is controlled based on which pages allow you to either view private data or pages that allow you to add new elements to the database.